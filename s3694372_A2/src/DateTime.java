...
public class DateTime {
	...
	public static int diffDays(DateTime endDate, DateTime startDate) {
		...
		long convertToDays = HOURS_IN_DAY * MINUTES_IN_HOUR * SECONDS_IN_MINUTES
	...
	/* This method will take a date with a delimeter and return
	formatted datetime */
	public static DateTime getDateTime(String date, String delim) {
		...
		if (sc.hasNext()) {
			...
			String day = sc.next();
			DateTime dt = new DateTime(Integer.parseInt(day),
